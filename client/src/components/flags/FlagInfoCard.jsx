...
import { Container, Card, Grid, Typography, Divider, Button, Dialog } from "@mui/material"
...
const FlagInfoCard = ({ flag }) => {
  ...
  const handleOnFlagUpdate = (flagData, callback) => {
    ...
    dispatch(updateFlagById({ flagId: id, body: flagWithoutId, callback: handleClose }));
  };
